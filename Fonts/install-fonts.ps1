# Install fonts from $DOTFILES\Fonts\InstallFonts
...
$SourceDir   = Join-Path $DOTFILES "Fonts\InstallFont"
$Source      = Join-Path $DOTFILES "Fonts\InstallFont\*"
$Destination = (New-Object -ComObject Shell.Application).Namespace(0x14)
$TempFolder  = Join-Path $DOTFILES "Fonts\Temp"
